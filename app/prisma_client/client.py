...
SCHEMA_PATH = Path('C:/Users/Apaz/backend-tickets/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Apaz\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    ticket: 'actions.TicketActions[models.Ticket]'
    ...
    def __init__(
        ...
        *,
        ...
        self.ticket = actions.TicketActions[models.Ticket](self, models.Ticket)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/Apaz/backend-tickets/prisma/schema.prisma',
        }
...
class Batch:
    ticket: 'TicketBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.ticket = TicketBatchActions(self)
